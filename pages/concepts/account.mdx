...
**Example: EOA Transfer Transaction**
```json
{
...
**Example:**
3-of-5 Multisig: Three of the five key holders must sign for the transaction to be valid.
...
**Example: Contract Deployment Using ethers.js**
```json
