...
```
   ...
   ![Create a new file in Remix](public/erc20_0.png)
...
3. MetaMask will auto-detect the token symbol and decimals. Click Add Custom Token.
   ...
   ![erc20](public/erc20_4.png)

4. Check your token balance.

    ![erc20](public/erc20_5.png)
